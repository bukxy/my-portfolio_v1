...
import com.peron_nicolas.portfolio.config.StorageProperties;
import com.peron_nicolas.portfolio.entity.Image;
import com.peron_nicolas.portfolio.enums.EntityTypeEnum;
import com.peron_nicolas.portfolio.handler.StorageException;
...
@Service
public class FileSystemStorageService implements FileSystemStorageServiceInterface {
    ...
    @Autowired
    public FileSystemStorageService(StorageProperties properties, ImageServiceInterface imageServiceInterface) {
    ...
    @Override
    public Image store(MultipartFile file, EntityTypeEnum entityTypeEnum, Long entityId) {
        try {
            if (file.isEmpty()) {
